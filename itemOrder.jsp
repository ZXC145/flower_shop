				...
				<div class="leftside-navigation">
					<ul class="sidebar-menu" id="nav-accordion">
						...
						<li class="sub-menu"><a class="active" href="javascript:;">
							...
							<ul class="sub">
								<li><a class="active" href="itemOrder.jsp">订单</a></li>
							</ul></li>
						<li class="sub-menu"><a href="javascript:;"> <i
						...
						<div class="panel-body minimal">
							...
							<div class="table-inbox-wrap ">
								<table class="table table-inbox table-hover">
									...
									<thead>
										<tr>
											<th data-breakpoints="xs">订单编号</th>
											<th>下单时间</th>
											<th>金额</th>
											<th>用户</th>
											<th>省份</th>
											...
											<th>联系电话</th>
											<th>收货人</th>
											<th data-breakpoints="xs">订单状态</th>
									</thead>
									<tbody>
										<tr data-expanded="true">
											...
											<td>High Schoolr</td>
											<td>High Schoolr</td>
											<td><a class="button border-main"
												href="${ctx}/orderDetail/ulist?orderId=${data.id}"><span
													class="glyphicon glyphicon-edit">查看购买商品</span> </a></td>
										</tr>
										<tr>
											<td>2</td>
											<td>Elodia</td>
